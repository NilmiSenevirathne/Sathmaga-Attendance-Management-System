...
function Home() {
  ...
  return (
    <div ref={homeRef}>
      ...
      <Navbar homeRef ={homeRef} aboutRef={aboutRef} contactRef={contactRef} /> {/* Pass refs to Navbar */}
      ...
      <section ref={contactRef} className="section contact-section" style={{
        ...
        <div className="contact-container">
          <h2>Contact Us</h2>
          <p>Email: rangasenevirathne1994@gmail.com</p>
          <p>Phone: +94 71 243 6069</p>
          <p>Address: Hospital Junction, Sathmaga Educational Institute, Hinguralakanda</p>
        </div>
      </section>
    </div>
  );
